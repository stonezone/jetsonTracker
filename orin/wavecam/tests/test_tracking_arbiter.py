...
def test_vision_takes_over_after_k_consecutive_locks():
    ...
    d1 = a.decide(_vision(True), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.0)
    assert d1.owner == "gps_tracker"
    d2 = a.decide(_vision(True), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.1)
    assert d2.owner == "gps_tracker"
    # Third lock — hand to vision
    d3 = a.decide(_vision(True), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.2)
...
def test_vision_holds_through_brief_unlock():
    ...
    # Lock in vision
    a.decide(_vision(True), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.0)
    a.decide(_vision(True), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.1)
    # Brief unlock within grace
    d = a.decide(_vision(False), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.2)
...
def test_vision_releases_after_grace():
    ...
    a.decide(_vision(True), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.0)
    a.decide(_vision(True), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.1)
    a.decide(_vision(False), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.2)
    # After grace expires + GPS viable → GPS takes over
    d = a.decide(_vision(False), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=1.0)
    assert d.owner == "gps_tracker"
...
def test_gps_loss_stops_when_gps_was_owning():
    a = TrackingArbiter()
    # GPS owns
    d1 = a.decide(_vision(False), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.0)
    assert d1.owner == "gps_tracker"
...
def test_vision_reacquired_within_grace_resets_timer():
    ...
    a.decide(_vision(False), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.2)
    d = a.decide(_vision(True), gps_fresh=True, gps_calibrated=True, base_locked=True, now_sec=0.4)
